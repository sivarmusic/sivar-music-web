      ...
      <header className="sticky top-0 z-20 bg-[#0a0008]/95 backdrop-blur-md border-b border-white/8">
        ...
        <div className="px-4 py-3 flex items-center gap-3 max-w-6xl mx-auto">
          ...
          <div className="hidden sm:flex items-center gap-3 flex-none">
            <a href="https://www.instagram.com/sivarmusic" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://open.spotify.com/user/sivarmusic" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.youtube.com/@sivarmusic" target="_blank" rel="noopener noreferrer"
