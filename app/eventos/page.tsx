        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-5">
            ...
            <Link href="/pinkfest" className="group block">
              <div className="bg-white/4 border border-white/10 group-hover:border-[#F472B6]/30 rounded-2xl overflow-hidden transition">
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <h2 className="text-white font-bold text-sm sm:text-base leading-tight">Pink Fest</h2>
            ...
            {events.map(event => {
              ...
              return (
                <Link key={event.id} href={`/eventos/${event.slug}`} className="group block">
                  <div className={`bg-white/4 border rounded-2xl overflow-hidden transition ${isPast ? 'border-white/8 opacity-60' : 'border-white/10 group-hover:border-[#F472B6]/30'}`}>
                    <div className="relative w-full aspect-[4/3]">
                      {event.imagen_url ? (
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      <h2 className="text-white font-bold text-sm sm:text-base leading-tight">{event.nombre}</h2>
