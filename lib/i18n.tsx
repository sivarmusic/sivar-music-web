...
const es = {
  ...
  'account.exploreEvents': 'Explorar eventos',
  ...
  'artistas.landing.feature2': 'Publicá y promocioná tus próximos shows',
  ...
  'artistas.panel.eventLat': 'Latitud',
  'artistas.panel.eventLng': 'Longitud',
  'artistas.panel.eventPrice': 'Precio por entrada (opcional)',
  'artistas.panel.eventMaxTickets': 'Máximo de entradas (opcional)',
  'artistas.panel.eventLink': 'Link externo (opcional)',
  'artistas.panel.eventPendingNote': 'Tu evento se revisará antes de publicarse — te avisamos por correo cuando esté confirmado.',
...
const en: Record<Key, string> = {
  ...
  'account.exploreEvents': 'Explore events',
  ...
  'artistas.landing.feature2': 'Publish and promote your upcoming shows',
  ...
  'artistas.panel.eventLat': 'Latitude',
  'artistas.panel.eventLng': 'Longitude',
  'artistas.panel.eventPrice': 'Ticket price (optional)',
  'artistas.panel.eventMaxTickets': 'Max tickets (optional)',
  'artistas.panel.eventLink': 'External link (optional)',
  'artistas.panel.eventPendingNote': "Your event will be reviewed before it's published — we'll email you once it's confirmed.",
